...
1. Add a screenshot of the output of the unit tests. If any failed, add a screenshot of the error message and a screenshot after you have fixed the errors:
   ...
   ```markdown
   ![Unit tests](screenshots/unit-tests-display.png)<img width="690" height="436" alt="Screenshot 2025-11-28 at 11 01 40" src="https://github.com/user-attachments/assets/61ba6676-3bb4-49d6-8b51-cfad9bae3d80" />
...
```markdown
![Added methods to the car park class](screenshots/methods-to-car-park.png)<img width="693" height="388" alt="Screenshot 2025-11-28 at 17 08 35" src="https://github.com/user-attachments/assets/213b85c0-dee1-45df-b0df-a24718656cd3" />
...
1. Add a screenshot of the output of the `main.py` file:
   ...
   ```markdown
   ![Main.py output](screenshots/main-py.png)<img width="821" height="443" alt="Screenshot 2025-11-28 at 19 01 45" src="https://github.com/user-attachments/assets/c84afba4-29e2-4eef-8e0b-4811e6a817bf" />
